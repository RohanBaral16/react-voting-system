...
export default function RegisterPrototype(){
    ...
    const nextStep = async () => {
        ...
        if (isValid) setFormCurrentStatus((prev)=>{
            return prev==='personal'?'location':  prev==='location'?'security' :  prev==='security' ? 'review' : 'personal'
    ...
    return(
            ...
            bg-inherit p-6 w-full max-w-200 space-y-6 mx-auto ">
                ...
                <RegistrationProgressBar
                    stepStatus={{
                        personal: formCurrentStatus==='personal'?'in-progress':'completed',
                        location: formCurrentStatus==='location'?'in-progress':formCurrentStatus==='personal'?'pending':'completed',
                        security: formCurrentStatus==='security'?'in-progress':formCurrentStatus==='review'?'completed':'pending',
                        ...
                        <>
                            ...
                            <div className="p-8 border-b border-slate-100 dark:border-slate-800">
                                ...
                                <p className="text-slate-500 dark:text-slate-400 text-base font-normal
                                 leading-relaxed text-center mt-2 max-w-lg mx-auto">
                                    ...
                                    National Identity Card for identity verification.
                                </p>
                            </div>
                            ...
                            <div className="p-8 space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    {/* 3. Phone Number */}
                                    <div className="flex flex-col gap-2">
                                        <label htmlFor="phoneNo" className="text-slate-700
                                    ...
                                    {/* 6. Voter ID */}
                                    <div className="flex flex-col gap-2">
                                        <label htmlFor="voterId" className="text-slate-700 dark:text-slate-300 
                                        text-sm font-semibold">
                                            Voter ID
                                        </label>
                                        <input
                        ...
                        <>
                            ...
                            <div className="p-8 space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <label htmlFor="localBody" className="text-slate-700 dark:text-slate-300 text-sm 
                                        font-semibold">Local Body</label>
                                        <input 
                                            id="localBody"
                                            type="text"
    ...
    <>
        ...
        <div className="p-8 border-b border-slate-100 dark:border-slate-800">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-base font-normal leading-relaxed text-center mt-2 max-w-lg mx-auto">
                Please verify all information. These details will be submitted for official voter verification.
            </p>
        </div>
        ...
        <div className="p-8 space-y-10">
            {(() => {
                const LABEL_STYLE = "text-slate-500 dark:text-slate-400 text-xs font-bold uppercase tracking-widest mb-1";
                const VALUE_STYLE = "text-slate-900 dark:text-white text-base font-semibold";
                const SECTION_TITLE = "text-blue-600 dark:text-blue-400 text-sm font-bold border-l-4 border-blue-600 pl-3 mb-6";
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-y-6 gap-x-8">
                                ...
                                <div>
                                    ...
                                    <p className={VALUE_STYLE}>{localBody? localBody : 'Not provided'}</p>
                                </div>
                                <div>
                                    <p className={LABEL_STYLE}>Ward No: </p>
                                    <p className={VALUE_STYLE}>{wardNo? wardNo : 'Not provided'}</p>
                                </div>
                            </div>
                        </div>
            ...
            <div className="bg-amber-500/5 border border-amber-500/20 rounded-lg p-4 flex gap-3 items-start">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                    By clicking submit, you certify that the information provided is true and accurate according to your official records.
                </p>
            </div>
        </div>
